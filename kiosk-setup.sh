...
# Install additional software: epel-release, dconf-editor, gnome-extensions-app, gnome-tweaks, gnome-shell-extension-dash-to-dock, Google Chrome
dnf install -y epel-release dconf-editor gnome-extensions-app gnome-tweaks gnome-shell-extension-dash-to-dock
